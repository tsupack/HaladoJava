...
public class NullCheckerPasswordTest {
    private NullCheckerPassword nullCheckerPassword;
    ...
    @Before
    public void setUp() {
        nullCheckerPassword = new NullCheckerPassword();
    ...
    public void valid_userIsValid_thenTrue() {
        ...
        gotValidatorResponse=nullCheckerPassword.valid(validUser);
    ...
    public void valid_userPasswordIsInvalid_thenFalse() {
        ...
        gotValidatorResponse=nullCheckerPassword.valid(invalidUser);
